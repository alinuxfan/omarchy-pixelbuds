...
not from a Pixel Buds Pro connected to a running machine — this plugin was
...
| [pixel-buds-pro-identity](pixel-buds-pro-identity.md) | the service UUID, and why there is no on-wire model name to read |
